...
void setup() {
  ...
  // Ir a 50% durante 10 segundos sin tomar datos
  analogWrite(PWM, 127);
  delay(10000);
...
void loop() {
  ...
  // Verificar si deben pasar 50 segundos para subir el PWM
  if (currentTime - lastStepTime >= 50000) {
    currentPWM += 26; // Incrementar ~10% (26/255 ≈ 10%)
  ...
  if (dataLogging) {
    ...
    delay(50); // Pequeño delay para no saturar el serial (20Hz)
  }
}
